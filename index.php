...
<main class="d-flex ">
    <div class="s-menu">
        <div class="flex-column p-3 text-white bg-dark d-none d-lg-flex s-menu__item" >
            ...
            <ul class="nav nav-pills  mb-auto">
                <li>
                    <a href="#" class="nav-link text-white" style="white-space: nowrap">
        ...
        <div class="d-flex flex-column bg-dark d-lg-none s-menu__item" >
            ...
            <ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
                <li>
                    <a href="#" class="nav-link link-light py-3 border-bottom" title="" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Dashboard">
                        <svg class="bi" width="24" height="24" role="img" aria-label="Dashboard"><use xlink:href="#speedometer2"></use></svg>
                    </a>
                </li>
                <li>
                    <a href="#" class="nav-link link-light py-3 border-bottom" title="" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Customers">
                    ...
                    <div class="table-responsive bg-dark">
                        <table class="table table-dark table-striped table-hover">
                            ...
                            <tr>
                                ...
                                <th class="col-6 col-md-5 col-lg-4 col-xl-3 col-xxl-2">Charge off</th>
                                <th class="col-6 col-md-5 col-lg-4 col-xl-3 col-xxl-2">Charge</th>
                            ...
                            <tr>
                                <th scope="row">1</th>
                                <td><h3 class="mb-0 h4">Mark</h3></td>
